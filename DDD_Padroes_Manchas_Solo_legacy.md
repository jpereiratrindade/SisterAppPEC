...
Este DDD foi substituído por DDD_Padroes_Manchas_Solo_vFinal.md.
Ele é mantido apenas para rastreabilidade conceitual e histórica.
Não deve ser usado para implementação ou interpretação.
