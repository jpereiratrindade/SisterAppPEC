...
\begin{itemize}
    ...
    \item \textbf{High $R_{ecol}$ ($>0.7$):} Terreno suave, estável, erosão controlada. Fatores de suavização aplicados às oitavas de alta frequência.
    \item \textbf{Low $R_{ecol}$ ($<0.3$):} Terreno caótico, "quebrado", com picos abruptos e vales profundos, simulando degradação ambiental.
\end{itemize}
