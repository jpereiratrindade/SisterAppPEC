...
\title{\textbf{SisterApp: Plataforma de Ecologia Computacional v3.8.3}\\Manual Técnico de Modelos Computacionais}
...
\end{tabular}
\date{16 de Dezembro de 2025 - v3.8.3 (Async Stable)}
\end{table}
...
Portado do motor Voxel para o Finite World, este modelo introduz a composição ponderada de frequências de ruído, permitindo controle fino sobre a morfologia do terreno.
...
\subsection{Perfis Padrão (Legacy)}
\begin{itemize}
