...
\subsection{Integração Machine Learning (v4.0.0 Experimental)}
O sistema incorpora um módulo experimental de Machine Learning para inferência de propriedades pedológicas e visuais, operando em modo híbrido (Physics-Guided ML).
...
\[ \mathbf{x} = [ \text{Depth}, \text{OM}, \text{Infiltration}, \text{Compaction} ] \]
