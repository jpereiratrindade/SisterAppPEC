...
O sistema de vegetação está atualmente em reestruturação para se adaptar ao novo modelo de terreno Finite World. O foco atual (v3.8.4) é a validação das camadas de análise topológica e pedológica.
