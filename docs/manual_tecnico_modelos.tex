...
\begin{itemize}
    ...
    \item \textbf{Estrato Superior (ES):} Arbustos e subarbustos. Crescimento lento e não pastejado. Acumula grande biomassa que, quando senescente (baixo vigor/NDVI), torna-se o \textbf{principal combustível} para incêndios de alta intensidade.
\end{itemize}
