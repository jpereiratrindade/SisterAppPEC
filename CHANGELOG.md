...
-   **Camera & Controls**:
    ...
    -   **Render Distance**:- **v3.8.1 (Current):** Refined Horizon/Fog blending, Fixed Sky Sphere clipping ("random figures"), Implemented Top-Down View, Added Views Menu, Disabled Preferences Persistence.
